...
userRoute.get(
  ...
  aut.requirelogin,
  aut.isBlocked,
  homeController.singleproductLoad
);
//home filter
...
userRoute.post(
  ...
  aut.requirelogin,
  aut.isBlocked,
  profileController.verifyadressLogin
);
userRoute.post(
  "/saveAddress",
  aut.requirelogin,
  aut.isBlocked,
  adressController.checkOutSaveAdress
);
userRoute.get(
  "/adressEdit",
  aut.requirelogin,
...
userRoute.get(
  ...
  aut.requirelogin,
  aut.isBlocked,
  adressController.addressEditLoad
);
userRoute.post(
  "/editAddress",
  aut.requirelogin,
  aut.isBlocked,
  adressController.addressEdit
);
userRoute.get(
  "/deleteAdress",
  aut.requirelogin,
  aut.isBlocked,
  adressController.adressDelete
);
userRoute.patch(
  "/submitReturn",
  aut.requirelogin,
  aut.isBlocked,
  profileController.submitReuturn
);
userRoute.get(
  "/orderView",
  aut.requirelogin,
...
userRoute.post(
  ...
  aut.requirelogin,
  aut.isBlocked,
  cartcontroller.wishListAddCart
);
userRoute.get(
  "/delete",
  aut.requirelogin,
...
userRoute.get(
  ...
  aut.requirelogin,
  aut.isBlocked,
  checkoutController.checkOutLoad
);
userRoute.post(
  "/applyCoupon",
  aut.requirelogin,
  aut.isBlocked,
  checkoutController.couponApply
);
userRoute.post(
  "/removeCoupon",
  aut.requirelogin,
...
userRoute.post(
  ...
  aut.requirelogin,
  aut.isBlocked,
  orderController.orderSucess
);
userRoute.get(
  "/ordersucess",
  aut.requirelogin,
  aut.isBlocked,
  orderController.orderComplete
);
userRoute.post(
  "/createOrder",
  aut.requirelogin,
  aut.isBlocked,
  paymentController.payOnline
);
userRoute.get(
  "/orderedOnline",
  aut.requirelogin,
...
userRoute.post(
  ...
  aut.requirelogin,
  aut.isBlocked,
  paymentController.saveFailOrder
);
userRoute.post(
  "/retryPayment",
  aut.requirelogin,
  aut.isBlocked,
  retryPaymentController.retryFailedOrder
);
...
userRoute.get(
  ...
  aut.requirelogin,
  aut.isBlocked,
  wishListControler.wishListLoad
);
userRoute.post(
  "/wishlist",
  aut.requirelogin,
  aut.isBlocked,
  wishListControler.Addwishlist
);
userRoute.get(
  "/Deletewishlist",
  aut.requirelogin,
  aut.isBlocked,
  wishListControler.deletewishlist
);
